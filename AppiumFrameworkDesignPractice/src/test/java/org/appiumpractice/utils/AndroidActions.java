...
public class AndroidActions extends AppiumUtils {
	...
	public void scrollUntilGivenTextIsVisible(String text) {
		driver.findElement(AppiumBy
				.androidUIAutomator("new UiScrollable(new UiSelector()).scrollIntoView(text(\"" + text + "\"));"));

	}

	public void scrollAndSelectOption(Object countryName) {
		driver.findElement(AppiumBy
				.androidUIAutomator("new UiScrollable(new UiSelector()).scrollIntoView(text(\"" + countryName + "\"));"))
				.click();
